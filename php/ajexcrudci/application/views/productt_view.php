...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <table id="mydata" class="hover" style="width:100%">
                <thead>
                    <tr>
                        <th>Product Code</th>
                        <th >Product Name</th>
                        ...
                        <td style="text-align: right;"><b>Actions</b></td> 
                  ...
                  <div class="modal-body">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label class="col-md-2 col-form-label">Image</label>
                            <div class="col-md-10">
                              <input type="file" name="image_edit" id="image_edit" class="form-control" placeholder="image">
                            </div>
                        </div> 
                  </div>
                  <div class="modal-footer">
...
<script type="text/javascript">
 ...
 $('#mydata thead tr ').clone(true).appendTo( '#mydata thead' );
    $('#mydata thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#mydata').DataTable( {
      ...
      //show button copy excel,pdf,print
      ...
      // scroll
		            ...
		            for(i=0; i<data.length; i++){
		                html += '<tr>'+
		                        ...
		                        '<td style="text-align:right;">'+
                                    '<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" data-product_code="'+data[i].product_code+'" data-product_name="'+data[i].product_name+'" data-price="'+data[i].product_price+'"data-price="'+data[i].product_pr+'">Edit</a>'+' '+
        ...
        $('#btn_save').on('click',function(){
            ...
            $.ajax({
                ...
                dataType : "JSON",
                data : {product_code:product_code , product_name:product_name, price:price,image:image},
                success: function(data){
